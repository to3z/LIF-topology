# -*- coding: utf-8 -*-
"""
LIF_1_1_3 model: 1+1+3 LIF topology for multi-task learning (mem-mixing design,
5 LIF slots).
...
- Stage 3: 3 LIFs (slots 2, 3, 4) see OLD mem[:,:,1] via lif_fc2 = nn.Linear(1, 3)
...
class SNN_Model_LIF_1_1_3(nn.Module):

    def __init__(self, n_tasks, topk=5):
        super(SNN_Model_LIF_1_1_3, self).__init__()
        ...
        self.lif_5 = lif_1_1_3(36 * 36 * 1, cfg_fc[0])
