...
class GaussianPolicy(nn.Module):
    def __init__(self, num_inputs, num_actions, hidden_dim, action_space=None):
        ...
        self.lif_1_2_2_layer1 = LIF_1_2_2_neuron(num_inputs, hidden_dim)
        self.lif_1_2_2_layer2 = LIF_1_2_2_neuron(5*hidden_dim, hidden_dim)
