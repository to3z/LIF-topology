...
class GaussianPolicy(nn.Module):
    def __init__(self, num_inputs, num_actions, hidden_dim, action_space=None):
        ...
        self.lif_1_1_1_1_layer1 = LIF_1_1_1_1_neuron(num_inputs, hidden_dim)
        self.lif_1_1_1_1_layer2 = LIF_1_1_1_1_neuron(4*hidden_dim, hidden_dim)
    ...
    def forward(self, state):
        ...
        x = self.lif_1_1_1_1_layer1(state)
